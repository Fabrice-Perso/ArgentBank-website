...
import { restoreSession, fetchUserProfileAsync } from "../../../redux/slices/authSlice"; // Importation des actions depuis le slice "authSlice" pour la gestion de la session utilisateur
